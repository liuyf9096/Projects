...
public:
    ...
    QString devid() { return mDevid; }
    QString clientid() { return mClientid; }

    virtual void setUnited(bool isUnited);
...
protected:
    ...
    virtual void cmd_Scan_Open(int timeout) = 0;
    virtual void cmd_Scan_Close() = 0;
    virtual bool cmd_Emergency_Open() = 0;
    virtual bool cmd_Emergency_Close() = 0;
    ...
    virtual void receiveFinished(QSharedPointer<RtSample> sample) = 0;
    virtual void recycleFinished(QSharedPointer<RtSample> sample) = 0;
...
private:
    ...
    void sendStationRotateTube(int duration);
    ...
    bool m_isClosetOpenFinish;
    bool m_isClosetCloseFinish;
    ...
    void operateClosetOpen();
    void operateClosetClose();
