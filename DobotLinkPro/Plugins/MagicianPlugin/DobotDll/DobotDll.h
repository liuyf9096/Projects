...
extern "C" DOBOTDLLSHARED_EXPORT int ConnectDobot(const char *portName, uint32_t baudrate, char *fwType, char *version, int *dobotId);
           DOBOTDLLSHARED_EXPORT int ConnectDobotSerial(QString portName, int *dobotId);
extern "C" DOBOTDLLSHARED_EXPORT int DisconnectDobot(int dobotId);

extern "C" DOBOTDLLSHARED_EXPORT int SetCmdTimeout(int dobotId, int cmdTimeout);
...
extern "C" DOBOTDLLSHARED_EXPORT int SetDeviceWithL(int dobotId, uint8_t version, bool isWithL);
...
extern "C" DOBOTDLLSHARED_EXPORT int SetColorSensor(int dobotId, bool enable,ColorPort colorPort, uint8_t version);
extern "C" DOBOTDLLSHARED_EXPORT int GetColorSensor(int dobotId, uint8_t *r, uint8_t *g, uint8_t *b);

extern "C" DOBOTDLLSHARED_EXPORT int SetInfraredSensor(int dobotId, bool enable,InfraredPort infraredPort, uint8_t version);
