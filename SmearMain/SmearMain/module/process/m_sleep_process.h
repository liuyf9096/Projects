#ifndef M_SLEEP_PROCESS_H
#define M_SLEEP_PROCESS_H

#include "m_process_base.h"

class MSleepProcess : public MProcessBase
{
    Q_OBJECT
public:
    explicit MSleepProcess(QObject *parent = nullptr);
